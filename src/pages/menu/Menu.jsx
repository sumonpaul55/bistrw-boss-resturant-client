    ...
    return (
        <main>
            ...
            <section className=''>
                ...
                <div className='todaysOffer py-10'>
                    <PageTitle heading="---Don't miss---" subHeading="TODAY'S OFFER" className="py-16"></PageTitle>
                    <MenuCategory items={offered}></MenuCategory>
                    {/* desser menu */}
                    <MenuCategory items={desserts} title="DESSERTS" coverImg={dessert} coverDesc="Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."></MenuCategory>
                    <MenuCategory items={fizza} title="fizza" coverImg={fizzaimg} coverDesc="Lorem Ipsum has been the industry’s standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book."></MenuCategory>
